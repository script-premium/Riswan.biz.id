...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/script-premium/Riswan.biz.id/main/REGIST | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
valid=$(curl https://raw.githubusercontent.com/script-premium/Riswan.biz.id/main/REGIST | grep $MYIP | awk '{print $3}')
...
Exp1=$(curl https://raw.githubusercontent.com/script-premium/Riswan.biz.id/main/REGIST | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/script-premium/Riswan.biz.id/main/"
start=$(date +%s)
secs_to_human() {
...
echo -e "\e[1;32m====================================================$NC"
echo -e "\033[91;1m contoh subdomain :\033[0m \033[93    
   vpn.gsvpn.cloud\033[0m"
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/script-premium/Riswan.biz.id/main/REGIST | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/script-premium/Riswan.biz.id/main/REGIST | grep $ipsaya | awk '{print $3}')
...
wget https://raw.githubusercontent.com/script-premium/Riswan.biz.id/main/files/limit.sh && chmod +x limit.sh && ./limit.sh
cd
